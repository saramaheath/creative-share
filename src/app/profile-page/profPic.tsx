...
export default function ProfPic(props: {userName: string, userImg: string}){

    return (
        <div className="">
            <div className="p-2 flex flex-row items-center section-pwhite mx-4 mt-4 rounded-md">
                <img src={props.userImg} alt="profile-pic" className="p-2 size-36 rounded-md"></img>
                <div className="p-2">
